...
<div class="row">
   <div class="shadow p-5 col-lg-6 m-auto">
      ...
      <br>
      <form action="/Admin/pesanan" method="POST">
         @csrf
         <div class="mb-3">
            <label for="kode_pesanan" class="form-label">Kode Pesanan</label>
            <input readonly type="text" class="form-control" id="kode_pesanan" name="kode_pesanan" value="{{ 'KP'.$tanggal->format('d').mt_rand(100, 999).mt_rand(100, 999).mt_rand(10000, 99999) }}">
            @error('kode_pesanan')
